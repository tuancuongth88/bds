...
function selectFile(index)
	...
	if(bReturnAbsolute)
		{
		sFile_RelativePath = window.location.protocol + "//" + window.location.host.replace(/:80/,"") + "/~thailoi/"+sFile_RelativePath
...
<input type="hidden" name="inpAssetBaseFolder0" id="inpAssetBaseFolder0" value="<?=$sBase0 ?>">
<input type="hidden" name="inpAssetBaseFolder1" id="inpAssetBaseFolder1" value="<?=$sBase1 ?>">
<input type="hidden" name="inpAssetBaseFolder2" id="inpAssetBaseFolder2" value="<?=$sBase2 ?>">
<input type="hidden" name="inpAssetBaseFolder3" id="inpAssetBaseFolder3" value="<?=$sBase3 ?>">
