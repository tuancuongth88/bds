...
function printYear(yy) {
	...
	var res = "";
	res += printStyle();
	res += '<table align="center" id="amlich" >\n';
...
function printStyle() {
	...
	res += '<!--\n';
	//res += '  body {margin:0}\n';
	res += '  #amlich { margin-left: 10px;text-align: center;}\n';
	res += '  .tennam {text-align:center; font-size:150%; line-height:120%; font-weight:bold; color:#000000; background-color: #CCCCCC}\n';
	res += '  .thang {font-size: '+fontSize+'; padding:1;margin-left:8px; line-height:100%; font-family:Tahoma,Verdana,Arial; table-layout:fixed}\n';
