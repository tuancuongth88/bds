        ...
        <div class="box-widget">
            ...
            <div class="widget-container">
                <div class="widget-block">
                    ...
                    <form method="POST" action="admin.php?act=bdsda_day" name="frmForm" enctype="multipart/form-data">
    
                    <input type="hidden" name="page" value="<?=$page?>">
    
                    <input type="hidden" name="act" value="bdsda_day">
                            ...
                            <thead>
                                ...
                                <tr align="center" >
                                  <td valign="middle"  colspan="7">
                                    <center>
                                        <div class="table_chu_tieude"><strong>Tin dự án trong ngày</strong></div>
                                    </center>
                                   </td>
                                </tr>
                                <tr align="center" >
