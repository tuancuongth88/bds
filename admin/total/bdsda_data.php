        ...
        <div class="box-widget">
            ...
            <div class="widget-container">
                <div class="widget-block">
                    ...
                    <form method="POST" action="admin.php?act=bdsda_data" name="frmForm" enctype="multipart/form-data">
    
                    <input type="hidden" name="page" value="<?=$page?>">
    
                    <input type="hidden" name="act" value="bdsda_data">
                            ...
                            <thead>
                                ...
                                <tr align="center" >
                                  <td valign="middle"  colspan="7">
                                    <center>
                                        <div class="table_chu_tieude"><strong>Thống kê dự án</strong></div>
                                    </center>
                                   </td>
                                </tr>
                                <tr align="center" >
...
<script src="http://code.jquery.com/ui/1.10.3/jquery-ui.js"></script>
                                ...
                                <tr >
                                  ...
                                  Tin nhập liệu: <?=countRecord("tbl_rv_item","type=1 and cate=2 $strDate AND ( iduser='{$idu}' or '{$idu}'=-1)")?> tin -  Tin đã chuyệt: <?=countRecord("tbl_rv_item","type=1  and cate=2 and active=1 $strDate AND ( iduser='{$idu}' or '{$idu}'=-1)")?> tin
