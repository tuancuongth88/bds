        ...
        <div class="box-widget">
            ...
            <div class="widget-container">
                <div class="widget-block">
                    ...
                    $where="1=1 AND cate=2  AND (id='{$tukhoa}' or name LIKE '%$tukhoa%' or '{$tukhoa}'=-1)";
					if($month !="" && $year!="" && $day!="") {
                    ...
                    <form method="POST" action="admin.php?act=bdsda_day_ano" name="frmForm" enctype="multipart/form-data">
    
                    <input type="hidden" name="page" value="<?=$page?>">
    
                    <input type="hidden" name="act" value="bdsda_day_ano">
