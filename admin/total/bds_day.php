        ...
        <div class="box-widget">
            ...
            <div class="widget-container">
                <div class="widget-block">
					...
					$where.=" AND type=1 AND ( iduser='{$idu}' or '{$idu}'=-1)  and ( Year(date_actived) = Year(CURRENT_TIMESTAMP)  AND Month(date_actived) = Month(CURRENT_TIMESTAMP)  AND Day(date_actived) = Day(CURRENT_TIMESTAMP) )"; 
                    ...
                    <form method="POST" action="admin.php?act=bds_day" name="frmForm" enctype="multipart/form-data">
    
                    <input type="hidden" name="page" value="<?=$page?>">
    
                    <input type="hidden" name="act" value="bds_day">
                            ...
                            <thead>
                                ...
                                <tr align="center" >
                                  <td valign="middle"  colspan="7">
                                    <center>
                                        <div class="table_chu_tieude"><strong>Tin trong ngày</strong></div>
                                    </center>
                                   </td>
                                </tr>
                                <tr align="center" >
...
<script src="http://code.jquery.com/ui/1.10.3/jquery-ui.js"></script>
                                ...
                                <tr >
                                  <td valign="middle" align="left" style="background-color:#F0F0F0; height:40px; padding-left:20px" colspan="7">Tổng số tin:
                                    <?=$totalRows?> 
tin - Thành tiền: <?=number_format($totalRows*$priceNL,0);?> đ </td>
                                </tr>
                               <tr>
