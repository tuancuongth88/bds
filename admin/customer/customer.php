...
if(isset($frame)==true){
	if($_SESSION['kt_login_level']!=4 && $_SESSION['kt_login_level']!=-1){
		...
		if(userPermissEdit($row_tbl_users['listEdit'],19,1)!=true) header("location: admin.php");
	}
}else{
...
$(document).ready(function() {	
	...
	<?php 
if(userPermissEdit($row_tbl_users['listEdit'],19,7 )==true  ||  $_SESSION['kt_login_level']==4 ||  $_SESSION['kt_login_level']==-1){
?>
	...
	obj = this;
		...
		$.ajax({
		   ...
		   data: 'id='+ id +'&table=tbl_users' +'&type=1&cate=19',
	...
	obj = this;
		...
		$.ajax({
		   ...
		   data: 'id='+ id +'&table=tbl_users' +'&type=5&cate=19',
        ...
        <div class="box-widget">
            ...
            <div class="widget-container">
                <div class="widget-block">
						...
						<?
                        if(userPermissEdit($row_tbl_users['listEdit'],19,4)==true ||  $_SESSION['kt_login_level']==4  ||   $_SESSION['kt_login_level']==-1  ){
                        ...
                        $where="1=1 and (id='{$tukhoa}' or email LIKE '%$tukhoa%' or mobile LIKE '%$tukhoa%' or username LIKE '%$tukhoa%' or name LIKE '%$tukhoa%' or '{$tukhoa}'=-1) and  idgroup=1 ";
                        ...
                        <form method="POST" action="admin.php?act=customer" name="frmForm" enctype="multipart/form-data">
                           ...
                           <table width="100%"  class="admin_table">
                            ...
                            <thead>
                                ...
                                <tr align="center" >
                                  <td valign="middle" style="background-color:#F0F0F0; height:40px; padding-left:20px" colspan="10"><input class="table_khungnho"  name="tukhoa" id="tukhoa" type="text" value="<?=$tukhoa?>"  placeholder="Từ khóa" />
                               ...
                               <tr>
                                 ...
                                 <td align="center" class="PageNum" colspan="7" height="30">
                                    	<?php echo pagesListLimit($totalRows,$pageSize);?>   
                                  </td>
                                  
                                 <td width="127" align="center" colspan="1">
                                 <? if(userPermissEdit($row_tbl_users['listEdit'],19,2)==true ||  $_SESSION['kt_login_level']==4 ||   $_SESSION['kt_login_level']==-1 ){?>
                                ...
                                <tr class="admin_tieude_table">
                                        ...
                                        <td width="137" align="center"><span class="title"><a class="title" href="<?=getLinkSort(3)?>">Hình</a></span></td>
                                        <td width="105" align="center"><a class="title" href="<?=getLinkSort(4)?>">Username</a></td>
                                        <!--<td width="10%" align="center"><a class="title" href="<?=getLinkSort(10)?>">Hình ảnh</a></td>-->
                                        <td width="164" align="center">Thông tin</td>
                                        <td width="144" align="center"><span class="title"><a class="title" href="<?=getLinkSort(11)?>"> Ngày vào</a></span></td>
                                        <td width="159" align="center"><a class="title" href="<?=getLinkSort(12)?>">Ngày tạo</a></td>
                                        <td width="83" align="center"><a class="title" href="<?=getLinkSort(12)?>">Spam</a></td>
                                        <td width="83" align="center"><a class="title" href="<?=getLinkSort(12)?>"> Kích hoạt</a></td>                                        
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td align="center"><span class="smallfont"><img src="images/anhien_<?=$row['warning']?>.png" alt="" width="25" height="25" class="spam" title="spam" value="<?=$row['id']?>" /></span></td>
                                        ...
                                        <td align="center">
                                         <? if(userPermissEdit($row_tbl_users['listEdit'],19,3)==true ||  $_SESSION['kt_login_level']==4 ||   $_SESSION['kt_login_level']==-1 ){?>
                                            <a href="admin.php?act=customer_m&cat=<?=$_REQUEST['cat']?>&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>"><img src="images/icon3.png"/></a>
                                         <? } ?>
                                         <? if(userPermissEdit($row_tbl_users['listEdit'],19,4)==true ||  $_SESSION['kt_login_level']==4 ||   $_SESSION['kt_login_level']==-1 ){?>
                                            <a  title="Xóa" href="admin.php?act=customer&action=del&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>" onclick="return confirm('Bạn có muốn xoá luôn không ?');" ><img src="images/icon4.png" width="20" border="0" /></a>
                                         <? }?>
                                        </td>
                                    </tr>
                                 <?php }?>  
                                ...
                                <thead>
                                    <tr>
                                        <td colspan="10"> <center> <div class="PageNum"> <?php echo pagesListLimit($totalRows,$pageSize);?> </div> </center></td>
                                    </tr>
                                </thead>
