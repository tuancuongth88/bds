...
if(isset($frame)==true){
	if($_SESSION['kt_login_level']!=4 && $_SESSION['kt_login_level']!=-1){
		...
		if(userPermissEdit($row_tbl_users['listEdit'],1,1)!=true) header("location: admin.php");
	}
}else{
...
<?php 
if(userPermissEdit($row_tbl_users['listEdit'],1,7 )==true  ||  $_SESSION['kt_login_level']==4 ||  $_SESSION['kt_login_level']==-1){
?>
	...
	obj = this;
		...
		$.ajax({
		   ...
		   data: 'id='+ id +'&table=tbl_rv_category' +'&type=1&cate=1',
...
<?php 
if(userPermissEdit($row_tbl_users['listEdit'],1,6)==true ||  $_SESSION['kt_login_level']==4 ||  $_SESSION['kt_login_level']==-1 ){
?>
	...
	obj = this;
		...
		$.ajax({
		   ...
		   data: 'id='+ id +'&table=tbl_rv_category' +'&type=2&cate=1',
        ...
        <div class="box-widget">
            ...
            <div class="widget-container">
                <div class="widget-block">
					...
					<?
                    if(userPermissEdit($row_tbl_users['listEdit'],1,4)==true ||  $_SESSION['kt_login_level']==4  ||   $_SESSION['kt_login_level']==-1  ){
                        switch ($_GET['action']){
                            case 'del' :
                                $id = $_GET['id'];
                ...
                <input type="hidden" name="act" value="bds_category">
                <?
                    ...
                    <table width="100%"  class="admin_table">
                            ...
                            <thead>
                                ...
                                <tr align="center" >
                                  <td valign="middle"  colspan="10">
                                    <center>
                                        ...
                                        <strong>DANH MỤC BẤT ĐỘNG SẢN</strong>
                                        </div>
                                    </center>
                                   </td>
                                </tr>
                               ...
                               <tr>
                                 ...
                                 <? if(userPermissEdit($row_tbl_users['listEdit'],1,2)==true ||  $_SESSION['kt_login_level']==4 ||   $_SESSION['kt_login_level']==-1 ){?>
                                  <div><a href="admin.php?act=bds_category_m">
						...
						?>
                            <tr>
                                ...
                                <td align="center">
                                 <? if(userPermissEdit($row_tbl_users['listEdit'],1,3)==true ||  $_SESSION['kt_login_level']==4 ||   $_SESSION['kt_login_level']==-1 ){?>
                                    <a href="admin.php?act=bds_category_m&cat=<?=$_REQUEST['cat']?>&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>"><img src="images/icon3.png"/></a>
                                 <?php }?>
                                 <? if(userPermissEdit($row_tbl_users['listEdit'],1,4)==true ||  $_SESSION['kt_login_level']==4 ||   $_SESSION['kt_login_level']==-1 ){?>
                                    <a  title="Xóa" href="admin.php?act=bds_category&action=del&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>" onclick="return confirm('Bạn có muốn xoá luôn không ?');" ><img src="images/icon4.png" width="20" border="0" /></a>
                                  <?php }?>
                                </td>
                            </tr>
                         <?php }?> 
