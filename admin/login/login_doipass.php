<?php
		...
		elseif ($md5_matkhaulay!=$md5_matkhaulay){$coloi=true; $error = "<br />Mật khẩu củ không đúng";}
			...
			$sql=sprintf("update tbl_users set password='%s' 
...
?>
    ...
    <form action="admin.php?act=login_doipass" method="post" name="formdoipass" id="formdoipass">
