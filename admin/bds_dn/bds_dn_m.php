...
if(isset($frame)==true){
	if($_SESSION['kt_login_level']!=4 && $_SESSION['kt_login_level']!=-1){
		...
		if( isset($_GET['id']) || !empty($_POST['id'])) {if(userPermissEdit($row_tbl_users['listEdit'],8,3)!=true) header("location: admin.php");}
		elseif(userPermissEdit($row_tbl_users['listEdit'],8,2)!=true) header("location: admin.php");
	}
}else{
...
<div class="f_dt">
		<div class="table_chu_tieude">
        	SỬA THÔNG TIN DOANH NGHIỆP BẤT ĐỘNG SẢN
        </div>
        <div class="clear"> </div>
