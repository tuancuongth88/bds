            ...
            <div class="widget-container">
                <div class="widget-block">
                    ...
                    if($parent!=-1 || $parent1!=-1) {
						...
						$where="1=1  and cate=5 and (id='{$tukhoa}' or name LIKE '%$tukhoa%' or '{$tukhoa}'=-1) and  ( parent in ({$parenstrt}) or id=$parent)";
					}
                    else $where="1=1 and cate=5  and (id='{$tukhoa}' or name LIKE '%$tukhoa%' or '{$tukhoa}'=-1)";
                    ...
                    <input type="hidden" name="act" value="bdsspam">
                            ...
                            <thead>
                                ...
                                <tr align="center" >
                                  <td valign="middle"  colspan="11">
                                    <center>
                                        <div class="table_chu_tieude"><strong>SPAM BẤT ĐỘNG SẢN</strong></div>
                                    </center>
                                   </td>
                                </tr>
                                <tr align="center" >
