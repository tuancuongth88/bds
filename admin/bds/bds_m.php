...
if(isset($frame)==true){
	if($_SESSION['kt_login_level']!=4 && $_SESSION['kt_login_level']!=-1){
		...
		if(isset($_GET['id']) || !empty($_POST['id'])) {
			if(userPermissEdit($row_tbl_users['listEdit'],2,3)!=true) header("location: admin.php");
		 
		}
		else if(userPermissEdit($row_tbl_users['listEdit'],2,2)!=true) header("location: admin.php");
...
if (isset($_POST['them'])==true && $iduser!="" && $iduser > 0)//isset kiem tra submit
{
	...
	if ($errMsg==''){ 
			...
			if (!empty($_POST['id'])){
					$oldid = $_POST['id'];
					$sql = "update tbl_rv_item set   name='".$name."',khachhang='".$khachhang."',diachi='".$diachi."',email='".$email."',dienthoai='".$dienthoai."',catebds='".$loai."',parent='".$parent1."',idcity='".$tinh."',idquan='".$huyen."',idphuong='".$phuong."',idstreet='".$duong."',sonha='".$sonha."',latitude='".$lat."',longitude='".$long."',detail='".$detail."',type='".$loaihinh."' , price='".$price."',donvi='".$donvi."', dientich='".$dientich."', huong='".$huong."', tinhtrangphaply='".$phaply."', dtkhuonvien='".$dtkhuonvien."', tongdtsudung='".$tongdtsudung."', solau='".$solau."', sophong='".$sophong."', namxaydung='".$namxaydung."', dacdiemkhac='".$ddk."', raoban_thue='".$raoban_thue."',  sort='".$sort."', title ='".$title ."', description ='".$description ."', keyword='".$keyword."', last_modified=now() where id='".$oldid."'";
				}else{
					  $sql = "insert into tbl_rv_item (code, iduser ,cate , idcity , type , name, khachhang , diachi , email , dienthoai  ,   parent, detail_short, detail , sort, price , donvi , dientich , huong , tinhtrangphaply , dtkhuonvien , solau , sophong , namxaydung , dacdiemkhac , raoban_thue , title, description , keyword, status , date_added, last_modified, lang) values ('".$code."','".$iduser."',0,'".$tinh."','".$loaihinh."','".$name."','".$khachhang."','".$diachi."','".$email."','".$dienthoai."','".$parent1."','".$txtDetailShort."','".$detail."','".$sort."','".$price."','".$donvi."','".$dientich."','".$huong."','".$phaply."','".$dtkhuonvien."','".$solau."','".$sophong."','".$namxaydung."','".$ddk."','".$raoban_thue."','".$title."','".$description."','".$keyword."','1',now(),now(),'".$lang."')";
			}
	...
	if (isset($_GET['id'])){
		...
		if ($result = mysql_query($sql,$conn)) {
			...
			if($_SESSION['kt_login_level']!=4 && $_SESSION['kt_login_level']!=-1){
					//kiem tra tinh
					userPermiss($row_tbl_users['id'],$row['idcity'],"admin.php");			 
...
<div class="f_dt">
	<div class="table_chu_tieude">
        SỮA THÔNG TIN BẤT ĐỘNG SẢN
    </div>
    <div class="clear"> </div>
    <form action="admin.php?act=bds_m" method="post" enctype="multipart/form-data" name=formdk id=formdk>
    <input type="hidden" name="act" value="bds_m" />
    <input type="hidden" name="id" value="<?=$_REQUEST['id']?>">
    <span class="note_dt" style="text-align:left;">
    ...
    <div class="b_dt_1">
        <ul>
            <li class="clearfix">
                ...
                <span class="l2_bdt"> 
                    <input name="khachhang" type="text" class="ipt_bdt box-sizing-fix" id="khachhang" title="Nhập tiêu đề" size="70" value="<?php echo $khachhang ?>" required="required" />
                </span>
            </li>
            <li class="clearfix">
                <span class="l1_bdt">
                ...
                <span class="l2_bdt">
                    <div class="sty_bdt"> 
                      <select name="loai" id="loai"  required="required"  > 
            ...
            <li class="clearfix">
                ...
                <span class="l2_bdt">
                    <div class="sty_bdt">
                        <select name="ddCat" id="ddCat"  required="required" > 
            ...
            <li class="clearfix">
                ...
                <span class="l2_bdt">
                 <input name="txtName" type="text" class="ipt_bdt box-sizing-fix" id="txtName" title="Nhập tiêu đề" size="70" value="<?php echo $name ?>"  required="required" /> 
                </span>
                <span>
                    <?=$errMsg_tieude;?>
                </span>
    ...
    <div class="b_dt_1">
        <ul>
          ...
          <li class="clearfix">
            ...
            <li class="clearfix">
                ...
                <span class="l2_bdt" style="text-align:left;"> 
        ...
        <script type="text/javascript" src="<?php echo $linkrootbds?>scripts/jquery.geocomplete.js"></script>
    ...
    <div class="b_dt_2" style="padding:0px;">
         ...
         <textarea id="noidung" name="noidung" rows="16" cols="80" style="width:100%;"  required="required"> <?=$detail?></textarea> 
            ...
            $(document).ready(function() {
                ...
                $(".upload").click(function() {
                    ...
                    //          break;
                            ...
                            $.ajax({
                               type: "POST",
                               url:'<?php echo $linkrootbds?>admin/file.php?id='+id,
                               processData: false,
                               contentType: false,
                               data: fd,
                               cache: false,
	...
	<div class="f_dt">
    	<div style="min-width:150px; margin:0 auto; text-align:center; width:100%;">
            ...
            <div style="text-align:center;">
                ...
                <script>
                s=2; 
                setTimeout("document.location='<?php echo $linkrootbds?>admin/admin.php?act=bds'",s*1000); 
                setInterval("document.getElementById('sogiay').innerHTML=s--;",1000);
                </script> 
                <a href="<?php echo $linkrootbds?>admin/admin.php?act=bds"> Link quay lại trang chủ ngay</a><br />
