...
if(isset($frame)==true){
	if($_SESSION['kt_login_level']!=4 && $_SESSION['kt_login_level']!=-1){
		...
		if(userPermissEdit($row_tbl_users['listEdit'],6,1)!=true) header("location: admin.php");
	}
...
$(document).ready(function() {	
	...
	<?php 
if(userPermissEdit($row_tbl_users['listEdit'],6,7 )==true  ||  $_SESSION['kt_login_level']==4 ||  $_SESSION['kt_login_level']==-1){
?>
	...
	obj = this;
		...
		$.ajax({
		   ...
		   data: 'id='+ id +'&table=tbl_rv_item' +'&type=1&cate=6',
...
<?php 
if(userPermissEdit($row_tbl_users['listEdit'],6,6)==true ||  $_SESSION['kt_login_level']==4 ||  $_SESSION['kt_login_level']==-1 ){
?>
	...
	obj = this;
		...
		$.ajax({
		   ...
		   data: 'id='+ id +'&table=tbl_rv_item' +'&type=2&cate=6',
        ...
        <div class="box-widget">
            ...
            <div class="widget-container">
                <div class="widget-block">
					...
					<?
 					if(userPermissEdit($row_tbl_users['listEdit'],6,4)==true ||  $_SESSION['kt_login_level']==4  ||   $_SESSION['kt_login_level']==-1  ){
						switch ($_GET['action']){
                        ...
                        <table width="100%"  class="admin_table">
                            ...
                            <thead>
                                ...
                                <tr align="center" >
                                  <td valign="middle" style="background-color:#F0F0F0; height:40px; padding-left:20px" colspan="10">   
                                    ...
                                    <select name="ddCat" id="ddCat" class="list_tim_loc"> 
                                            ...
                                            <?php   
											$gt=get_records("tbl_rv_category","parent=2 and cate=2 and status=1 ","id DESC"," "," ");
                               ...
                               <tr>
                                 ...
                                 <? if(userPermissEdit($row_tbl_users['listEdit'],6,2)==true ||  $_SESSION['kt_login_level']==4 ||   $_SESSION['kt_login_level']==-1 ){?>
                           ...
                           $sql="select *,DATE_FORMAT(date_added,'%d/%m/%Y %h:%i') as dateAdd,DATE_FORMAT(last_modified,'%d/%m/%Y %h:%i') as dateModify from tbl_rv_item where  $where $sortby limit ".($startRow).",".$pageSize;
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
     									<? if(userPermissEdit($row_tbl_users['listEdit'],6,3)==true ||  $_SESSION['kt_login_level']==4 ||   $_SESSION['kt_login_level']==-1 ){?>
