...
if(isset($frame)==true){
	if($_SESSION['kt_login_level']!=4 && $_SESSION['kt_login_level']!=-1){
		...
		if(userPermissEdit($row_tbl_users['listEdit'],20,1)!=true) header("location: admin.php");
	}
}else{
        ...
        <div class="box-widget">
            ...
            <div class="widget-container">
                <div class="widget-block">
						...
						<?
                        if(userPermissEdit($row_tbl_users['listEdit'],20,4)==true ||  $_SESSION['kt_login_level']==4  ||   $_SESSION['kt_login_level']==-1  ){
                        ...
                        $where="1=1 and (id='{$tukhoa}' or email LIKE '%$tukhoa%' or mobile LIKE '%$tukhoa%' or username LIKE '%$tukhoa%' or name LIKE '%$tukhoa%' or '{$tukhoa}'=-1) and  idgroup=2 ";
                        ...
                        <form method="POST" action="admin.php?act=custom_data" name="frmForm" enctype="multipart/form-data">
                            <input type="hidden" name="page" value="<?=$page?>">
                            <input type="hidden" name="act" value="custom_data">
                            ...
                            <thead>
                                ...
                                <tr align="center" >
                                  <td valign="middle"  colspan="9">
                                    <center>
                                        <div class="table_chu_tieude"><strong>NHẬP LIỆU</strong></div>
                                    </center>
                                   </td>
                                </tr>
                                <tr align="center" >
                                ...
                                <tr >
                                  <td valign="middle" align="left" style="background-color:#F0F0F0; height:40px; padding-left:20px" colspan="9"> 
                                        <div class="link_loc" style="width:80px;text-align:center; padding:3px; border:solid 1px #999; float:left; margin-right:5px;<?php if($noibat==0  &&  $anhien==0) echo 'background-color:#FF0; color:#000;';else echo 'background-color:#FFF; color:#FFF;"';?>">
                                        	<a href="admin.php?act=custom_data&tang=1&anhien=-1&noibat=-1">Tất cả</a>
                                        </div>
                                        <div class="link_loc" style="width:80px; text-align:center; padding:3px; border:solid 1px #999; float:left; margin-right:5px;<?php if($tang==1) echo 'background-color:#FF0; color:#000;';else echo 'background-color:#FFF; color:#FFF;"';?>" >
                                        	<a href="admin.php?act=custom_data&tang=1&anhien=<?php echo $_SESSION['kt_anhien'] ?>&noibat=<?php echo $_SESSION['kt_noibat']?>">Tăng dần</a>
                                        </div>
                                        <div class="link_loc" style="width:80px;text-align:center; padding:3px; border:solid 1px #999; float:left; margin-right:5px;<?php if($tang==0) echo 'background-color:#FF0; color:#000;';else echo 'background-color:#FFF; color:#FFF;"';?>">
                                        	<a href="admin.php?act=custom_data&tang=0&anhien=<?php echo $_SESSION['kt_anhien'] ?>&noibat=<?php echo $_SESSION['kt_noibat']?>">Giảm dần</a>
                                        </div>
                                        <div class="link_loc" style="width:80px;text-align:center; padding:3px; border:solid 1px #999; float:left; margin-right:5px;<?php if($anhien==1) echo 'background-color:#FF0; color:#000;';else echo 'background-color:#FFF; color:#FFF;"';?>">
                                        	<a href="admin.php?act=custom_data&tang=<?php echo $_SESSION['kt_tang'] ?>&anhien=1&noibat=<?php echo $_SESSION['kt_noibat'] ?>">  Kích hoạt</a>
                                        </div>
                                         <div class="link_loc" style="width:120px;text-align:center; padding:3px; border:solid 1px #999; float:left; margin-right:5px;<?php if($anhien==0) echo 'background-color:#FF0; color:#000;';else echo 'background-color:#FFF; color:#FFF;"';?>">
                                        	<a href="admin.php?act=custom_data&amp;tang=<?php echo $_SESSION['kt_tang'] ?>&amp;anhien=1&amp;noibat=<?php echo $_SESSION['kt_noibat'] ?>">Chưa</a> <a href="admin.php?act=custom_data&tang=<?php echo $_SESSION['kt_tang'] ?>&anhien=0&&noibat=<?php echo $_SESSION['kt_noibat'] ?>">Kích hoạt</a>
                                        </div>
                                        <div class="link_loc" style="width:80px;text-align:center; padding:3px; border:solid 1px #999; float:left; margin-right:5px;<?php if($noibat==1) echo 'background-color:#FF0; color:#000;';else echo 'background-color:#FFF; color:#FFF;"';?>">
                                        	<a href="admin.php?act=custom_data&tang=<?php echo $_SESSION['kt_tang'] ?>&anhien=<?php echo $_SESSION['kt_anhien'] ?>&noibat=1">Nổi bật</a>
                                        </div>
                                         <div class="link_loc" style="width:80px;text-align:center; padding:3px; border:solid 1px #999; float:left; margin-right:5px;<?php if($noibat==0) echo 'background-color:#FF0; color:#000;';else echo 'background-color:#FFF; color:#FFF;"';?>">
                                        	<a href="admin.php?act=custom_data&tang=<?php echo $_SESSION['kt_tang'] ?>&anhien=<?php echo $_SESSION['kt_anhien'] ?>&noibat=0">ko nổi bật</a>
                                        </div>
                                  </td>
                                </tr>
                               <tr>
                                 ...
                                 <? if(userPermissEdit($row_tbl_users['listEdit'],20,2)==true ||  $_SESSION['kt_login_level']==4 ||   $_SESSION['kt_login_level']==-1 ){?>
                                  <div><a href="admin.php?act=custom_data_m">
                                ...
                                <tr class="admin_tieude_table">
                                        ...
                                        <td width="13%" align="center"><a class="title" href="<?=getLinkSort(12)?>">Ngày tạo</a></td>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td align="center"><?php if($row['image']==true){ ?>
                                          <a onclick="positionedPopup (this.href,'myWindow','500','400','100','400','yes');return false" href="<?=$row['hinh1']?>" title="Click vào xem ảnh"> <img src="../<?=$row['image']?>" width="80" height="80" border="0" class="hinh" /></a>
                                          <?php }else{?>
                                        ...
                                        Email:<?=$row['email']?> 
                                          ...
                                          <p> 
                                          Số tin đã đăng: <?=countRecord("tbl_rv_item"," iduser='".$row['id']."' and type=1")?>
                                          </p>
                                             <p> 
                                          Số tin đã duyệt: <?=countRecord("tbl_rv_item"," iduser='".$row['id']."' and type=1 and active")?>
                                          </p>
                                        </td>
                                        <td align="center"><?=$row['last_loged']?></td>
                                        <td align="left"><p>Ngày tạo:
                                          <?=$row['dateAdd']?>
                                        </p>
                                          <p>Ngày sửa:
                                            <?=$row['dateModify']?>
                                        ...
                                        <td align="center">
                                         <? if(userPermissEdit($row_tbl_users['listEdit'],20,3)==true ||  $_SESSION['kt_login_level']==4 ||   $_SESSION['kt_login_level']==-1 ){?>
                                            <a href="admin.php?act=custom_data_m&cat=<?=$_REQUEST['cat']?>&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>"><img src="images/icon3.png"/></a>
                                         <? } ?>
                                         <? if(userPermissEdit($row_tbl_users['listEdit'],20,4)==true ||  $_SESSION['kt_login_level']==4 ||   $_SESSION['kt_login_level']==-1 ){?>
                                            <a  title="Xóa" href="admin.php?act=custom_data&action=del&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>" onclick="return confirm('Bạn có muốn xoá luôn không ?');" ><img src="images/icon4.png" width="20" border="0" /></a>
                                         <? }?>
                                        </td>
                                    </tr>
                                 <?php }?>  
