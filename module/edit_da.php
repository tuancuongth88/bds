...
?>    
<div class="f_dt">
    	<form action="<?php echo $linkrootbds?>sua-du-an/<?=$row_sanpham['subject']?>.html" method="post" enctype="multipart/form-data" name=formdk id=formdk>
        <input type="hidden" name="act" value="edit_da" />
        <span class="note_dt">
        ...
        <div class="btn_bdt"> 
            <input type="submit" name="them" class="nut-table" value=" Sửa tin" title="Chấp nhận hoàn thành " />
              <a href="<?php echo $linkrootbds?>quan-ly-tin-dang-du-an.html"><input type="button" name="quayra" class="nut-table" value="Quay ra" title="Quay ra ngoài " /> </a>
        </div><!-- End .btn_bdt -->
        </form>
