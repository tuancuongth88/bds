        ...
        <div class="f1_pD">
            ...
            <div id="gallery-1" class="royalSlider rsMinW">
				...
				?>
                    ...
                    <a class="rsImg bugaga" href="<?php echo $img_larg_array[$ii];?>">
                        <img class="rsTmb" src="<?php echo $img_array[$ii];?>" alt=""/>
                    </a> 
                <?php  
						}
					}
				for($i=$kk;$i<6;$i++){
				?>
                <a class="rsImg bugaga" href="imgs/noimage_large.png">
    ...
    <div class="f_da">
        <div class="sliderhs">
			<ul class="bxslider">              
				...
				?>
					<li>
						<img class="rsTmb" src="<?php echo $linkrootbds?>imgs/noimage_large.png" alt="<?=$row_sanpham['name']?>"/>
					</li>
				<?php 
				}
				?>
				...
				<?php
					...
					for($i=0;$i<6;$i++){
						...
						if($row_sanpham['image'.$i]!="")
						{
							...
							?>		
								<a data-slide-index="<?php echo $kk;?>" href=""><img src="<?php echo $img_array[$ii];?>" alt=""/></a>
							<?php  
							$kk++;	
						}
					}
    ...
    <div class="f_da">
        <div id="gallery-2" class="royalSlider rsMinW">
			...
			?>
				...
				<a class="rsImg bugaga" href="<?php echo $img_larg_array[$ii];?>">
					<img class="rsTmb" src="<?php echo $img_array[$ii];?>" alt="<?=$row_sanpham['name']?>"/>
				</a> 
			<?php  
					}
				}
