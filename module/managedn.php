 <?php 
	...
	$startRow = ($pageNum-1) * $pageSize;
     ...
     $totalRows = countRecord("tbl_rv_item"," cate=3 and  iduser=$iduser"); 
	 //echo "status=1 $chuoit AND parent in ({$parent}) order by $xapxep limit ";
	$bds=get_records("tbl_rv_item"," cate=3 and iduser=$iduser  order by $xapxep limit ".$startRow.",".$pageSize," "," "," ");	
...
<div class="f_cont clearfix">
    ...
    <article class="content">
        ...
        <div class="page">
            <div class="PageNum">
				<?php  
                echo pagesLinks_new_full_2013($totalRows, $pageSize , "","p","page-quan-ly-tin-dang-doanh-nghiep");
                ?>
            </div>
            <div class="clear"></div>
        </div><!-- End .page --> 
