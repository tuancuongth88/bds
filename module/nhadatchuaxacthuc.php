...
<div class="f_cont clearfix">
    ...
    <article class="content">
                    ...
                    ?>
                        <li>
                            <div class="li_prod clearfix">
                                <span class="lp_1">
                                    <a rel="nofollow" href="<?php echo $linkrootbds?><?php echo $row_bds['subject'];?>.html" title="<?php echo $row_bds['name'];?>">
										<?php 
                                ...
                                <span class="lp_2">
                                    ...
                                    <ul class="tool_icon">
                                     <li class="ti_1">
                                        ...
                                        <li class="ti_3">
                                         <a  rel="nofollow" href="<?php echo $linkrootbds?><?=$linkrootbds?><?php if($row_bds['image']!="") echo $row_bds['image'];else echo "imgs/noimage.png";?>" style="color:#888;" target="_blank">
										 <?php echo rand(7, 75);?>
                                         </a>
                                        </li>
                                    </ul>
        ...
        <div class="page">
            <div class="PageNum">
                <?php  
                echo pagesLinks_new_full_2013($totalRows, $pageSize , $root,"p","page-nha-dat-chua-xac-thuc");
                ?>
            </div>
            <div class="clear"></div>
        </div>
